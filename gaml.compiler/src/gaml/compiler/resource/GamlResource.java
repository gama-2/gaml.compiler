...
import static gama.annotations.common.interfaces.IGamlIssue.IMPORT_ERROR;
import static gaml.compiler.indexer.GamlResourceIndexer.collectMultipleImportsOf;
import static gaml.compiler.indexer.GamlResourceIndexer.getImportObject;
import static gaml.compiler.indexer.GamlResourceIndexer.updateImports;
import static gaml.compiler.resource.GamlResourceServices.properlyEncodedURI;
import static gaml.compiler.resource.GamlResourceServices.updateState;
import static gaml.core.compilation.GAML.getModelFactory;
