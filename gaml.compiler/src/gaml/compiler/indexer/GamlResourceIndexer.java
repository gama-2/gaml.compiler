/*******************************************************************************************************
 *
 * GamlResourceIndexer.java, in gaml.compiler, is part of the source code of the GAMA modeling and simulation
 * platform (v.1.9.0).
 *
...
import gaml.compiler.resource.GamlResource.ImportedResources;
...
public class GamlResourceIndexer {
	...
	/**
	 * @see gaml.compiler.indexer.IModelIndexer#directImportersOf(org.eclipse.emf.common.util.URI)
	 */
